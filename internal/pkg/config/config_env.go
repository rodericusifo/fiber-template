...
type (
	...
	IsRebuildDataDBSeederMysqlRole bool
)

type (
	IsRebuildDataDBSeederPostgresUser bool
	IsRebuildDataDBSeederPostgresRole bool
)
...
type EnvConfig *struct {
	...
	DatabaseSeederMysqlRoleIsRebuildData    IsRebuildDataDBSeederMysqlRole    `mapstructure:"DATABASE_SEEDER_MYSQL_ROLE_IS_REBUILD_DATA"`
	DatabaseSeederPostgresRoleIsRebuildData IsRebuildDataDBSeederPostgresRole `mapstructure:"DATABASE_SEEDER_POSTGRES_ROLE_IS_REBUILD_DATA"`
