...
func (_m *IEmployeeDatabaseSQLRepository) CountAllEmployee(query *types.QuerySQL) (int, error) {
	ret := _m.Called(query)

	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(*types.QuerySQL) (int, error)); ok {
		return rf(query)
	}
	if rf, ok := ret.Get(0).(func(*types.QuerySQL) int); ok {
		r0 = rf(query)
	} else {
		r0 = ret.Get(0).(int)
	}
...
func (_m *IEmployeeDatabaseSQLRepository) GetEmployee(query *types.QuerySQL) (*sql.Employee, error) {
	ret := _m.Called(query)
...
func (_m *IEmployeeDatabaseSQLRepository) GetListEmployeeAndCount(query *types.QuerySQL) ([]*sql.Employee, int, error) {
	ret := _m.Called(query)

	var r0 []*sql.Employee
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(*types.QuerySQL) ([]*sql.Employee, int, error)); ok {
		return rf(query)
	}
	if rf, ok := ret.Get(0).(func(*types.QuerySQL) []*sql.Employee); ok {
		r0 = rf(query)
	...
	if rf, ok := ret.Get(1).(func(*types.QuerySQL) int); ok {
		r1 = rf(query)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(*types.QuerySQL) error); ok {
		r2 = rf(query)
	} else {
		r2 = ret.Error(2)
	}
