...
func (_m *IEmployeeService) GetListEmployee(payload *input.GetListEmployeeDTO) (output.GetListEmployeeDTO, *types.Meta, error) {
	ret := _m.Called(payload)

	var r0 output.GetListEmployeeDTO
	var r1 *types.Meta
	var r2 error
	if rf, ok := ret.Get(0).(func(*input.GetListEmployeeDTO) (output.GetListEmployeeDTO, *types.Meta, error)); ok {
		return rf(payload)
	}
	...
	if rf, ok := ret.Get(1).(func(*input.GetListEmployeeDTO) *types.Meta); ok {
		r1 = rf(payload)
	} else {
		if ret.Get(1) != nil {
